function out = our_work_SIengine(N_data,freq,snr_dB,p,f,t_f)
...
% p = 30; % order of past data (default: 30)
% f = 70;  % order of future data (default: 70)
...
out.gamma_min = gamma_min;
out.gamma = gamma;
out.time = time;
out.u_id = u_id;
out.y_id = y_id;
out.scaled_integrated_noise = scaled_integrated_noise;
out.integrated_noisy_y_id = integrated_noisy_y_id;
out.uf = uf;
out.y_openLoop = y_openLoop;
